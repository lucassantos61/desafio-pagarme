        ...
        <div class="col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3">
            ...
            <form id="payment_form" action="{{route('checkout')}}" method="POST">
                ...
                <div class="form-group">
                    <input type="text" name="nome" id="full-name" class="form-control" placeholder="Nome Completo ou Razão Social">
                </div>
                <div class="form-group">
                    <input type="text" name="document_number" id="document-number" class="form-control" placeholder="CPF ou CNPJ" pattern="[0-9]{1,14}">
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="card_number" class="form-control" id="card-number" minlength="16" maxlength="16" placeholder="Número do Cartão">
                ...
                <div class="input-group">
                    <input type="text" name="month" class="form-control" id="card_expiration_month" placeholder="Mês de Expiração (MM)" pattern="[0-9]{1,2}" maxlength="2" size="2">
                    <span class="input-group-addon">/</span>
                    <input type="text" name="year" class="form-control" id="card_expiration_year" placeholder="Ano de Expiração (AA)" pattern="[0-9]{1,2}" maxlength="2" size="2">
                </div>
                <!-- Payment Data -->
